...
durable behavior. For example, if the user asks Claude Code to create or update
a local `AGENTS.<folder-name>.md` file in every conversation, update the local
