...
relation governance, project-scope rehoming, or capture-confirmation tokens.
It does include benchmark-proven relation-query batching. Existing explicit export/import,
