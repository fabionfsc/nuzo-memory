<section class="nuzo-hero">
  ...
  <p class="nuzo-progress__label"><strong>0.2.0</strong> current release</p>
...
Nuzo `0.2.0` is the current public release. It includes a TypeScript core package, a local CLI backed by SQLite, an MCP server, host plugin artifacts, published npm runtime packages, and installed-package validation.
...
| Release | `0.2.0` packages, tag, CI, Pages, plugin packaging, release-state checks, and published package smoke tests. |
